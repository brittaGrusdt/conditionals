...
```{r param-sweep-data}
data <- readRDS(file.path("data", "default-model", "results-voi-default.rds"))
voi_none <- readRDS(file.path("data", "default-model", "results-none-voi.rds"))
```

```{r}
voi_none %>% filter(key=="epistemic_uncertainty") %>%
